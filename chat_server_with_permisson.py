...
#==============================================================================
            if code == M_CONNECT:
                ...
                # connect to the peer
                    ...
                    found, group_key = self.group.find_group(to_name)
                    if not found:
                        leader = to_name
                    else:
                        leader = self.group.chat_grps[group_key][0]
                    msg = M_CONNECT + '['+from_name +'] wants to connect to you!'
                    to_sock = self.logged_name2sock[leader]
                    mysend(to_sock,msg)
                else:
...
#==============================================================================
                ...
                to_name = msg[msg.index("[")+1:msg.index("]")]
                to_sock = self.logged_name2sock[to_name]
                mysend(to_sock,msg)
#==============================================================================
# connect successfully after winning Simon
#==============================================================================
            elif code == M_CONNSUCCESS:
                to_name = msg[1:]
                from_name = self.logged_sock2name[from_sock]
                to_sock = self.logged_name2sock[to_name]
                self.group.connect(from_name,to_name)
                the_guys = self.group.list_me(from_name)
                msg = M_CONNSUCCESS + 'OK'
                for g in the_guys[1:]:
                    to_sock = self.logged_name2sock[g]
                    mysend(to_sock,M_CONNSUCCESS + from_name)
                mysend(from_sock,msg)
#==============================================================================
